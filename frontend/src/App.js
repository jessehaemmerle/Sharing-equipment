    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white p-8 rounded-lg shadow-md text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Gerät erfolgreich inseriert!</h2>
          <p className="text-gray-600">Dein Gerät ist jetzt zur Vermietung verfügbar.</p>
        </div>
      </div>
    );
  }
