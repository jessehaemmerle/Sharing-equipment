...
def debug_equipment_creation():
    print_separator("DEBUGGING EQUIPMENT CREATION ISSUE")
    ...
    user_data = {
        "email": random_email(),
        "name": f"Debug User {random_string()}",
    ...
    logger.info("Step 2: Creating equipment...")
    
    equipment_data = {
        "title": f"Debug Equipment {random_string()}",
        "description": "This is a test equipment for debugging the creation issue.",
